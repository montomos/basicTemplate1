...
Execute the install command in the root directory of "basictemplate01" repository.

```shell
$ cd path/to/basictemplate01
...
This project is created on 2015-03-09 using [generator-rff](https://github.com/rakuten-frontend/generator-rff) v0.5.1.
